#ifndef _HI2CxxCHANNELxx_H
#define _HI2CxxCHANNELxx_H
...
/**
    How to use:
    Zmenit vsetky vyskyty xxCHANNELxx za jedinecke cislo, resp. identifikator i2c zbernice (xxCHANNELxx to 0)
    Zmenit xxSDAPINxx za cislo pinu na ktorom su pripojene data (xxSDAPINxx to 10, pre pin PB10) 
    Zmenit xxSDAPORTxx za pismeno portu (xxSDAPORTxx to B, pre pin PB10)
    Zmenit xxCLKPINxx za cislo pinu na ktorom su master hodinovy clock to 10, (xxCLKPINxx to 9 pre pin PA9) 
    Zmenit xxCLKPORTxx za pismeno portu (xxCLKPORTxx to A, pre pin PA9)
...
*/
#define HI2CxxCHANNELxx_NACK    (1u<<0u)
...
\b description: \n
 ...
 The error is  returned by HI2C<unit>_ucGetError().
*/
#define HI2CxxCHANNELxx_TIMEOUT (1u<<1u)
...
*/
extern const uint8_t HI2CxxCHANNELxx_ucMaxWaitState;

extern uint8_t HI2CxxCHANNELxx_ucError;
extern uint8_t HI2CxxCHANNELxx_ucLastRx;
extern bool  HI2CxxCHANNELxx_bEventEnabled;

extern bool HI2CxxCHANNELxx_writeByte(uint8_t addr, bool stop, uint8_t data);
extern bool HI2CxxCHANNELxx_writeAddr(uint8_t addr, bool stop);
extern bool HI2CxxCHANNELxx_isChipPresent(void);
extern uint8_t HI2CxxCHANNELxx_readByte(uint8_t addr, bool stop);
extern uint8_t HI2CxxCHANNELxx_getChipAddress(void);
extern void HI2CxxCHANNELxx_setChipAddress(uint8_t chipAddress);
...
extern void HI2CxxCHANNELxx_vInitPort(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vOutputSCL(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vOutputSDA(void);
...
return:
 type:
            void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vInputSCL(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vInputSDA(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vClrSCL(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vSetSCL(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vClrSDA(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern void HI2CxxCHANNELxx_vSetSDA(void);
...
return:
 type:
           void
$HE****************************************************************************************************/
extern bool HI2CxxCHANNELxx_bGetSCL(void);
...
return:
 type:
            void
$HE****************************************************************************************************/
extern bool HI2CxxCHANNELxx_bGetSDA(void);
...
extern void HI2CxxCHANNELxx_vInit(uint8_t chipAddress);
...
\return: The function returns true, if the setting of the address was successful,
 ...
 \b range: true, false
*/
extern bool HI2CxxCHANNELxx_bSetAddr(uint8_t ucAddress);
...
\return The function returns true, if the setting of the data was successful, false otherwise.\n
 ...
 \b range: true, false
*/
extern bool HI2CxxCHANNELxx_bSetTxData(uint8_t ucDataByte, bool bStop);
...
\return This interface returns the received data byte.\n
  ...
  \b range: 0x00..0xFF
*/
#define HI2CxxCHANNELxx_ucGetRxData()   (HI2CxxCHANNELxx_ucLastRx)
...
\return none
*/
extern uint8_t HI2CxxCHANNELxx_vTriggerReceive(bool bStop);
...
\return none
*/
extern void HI2CxxCHANNELxx_vHandleEvent(void);
...
\return none
*/
#define HI2CxxCHANNELxx_vEnableEvent() { HI2CxxCHANNELxx_bEventEnabled = 1u; }
...
\return none
*/
#define HI2CxxCHANNELxx_vDisableEvent() { HI2CxxCHANNELxx_bEventEnabled = 0u; }
...
\return
 \b type:  uint8_t\n
 \b range:
           - HI2CxxCHANNELxx_NACK    This information is set whenever the acknowledge of the addressed partner was
                          not detected.

           - HI2CxxCHANNELxx_TIMEOUT This information is set whenever the partner has inserted to many waitstates
                          (stuck SCL).
*/
#define HI2CxxCHANNELxx_ucGetError()  (HI2CxxCHANNELxx_ucError)
...
*/
extern void HI2CxxCHANNELxx_vSendStop(void);
...
*/
extern bool HI2CxxCHANNELxx_bForceBusRelease(void);
...
\return none
*/
extern void HI2CxxCHANNELxx_vBitDelayH(void);
...
\return none
*/
extern void HI2CxxCHANNELxx_vBitDelayL(void);

#endif // _HI2CxxCHANNELxx_H
